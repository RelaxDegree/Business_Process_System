  ...
  <el-container style="height: 580px">
    ...
    <el-main>
      <el-menu @open="handleOpen">
        ...
        >
          <template slot="title"
            ><i class="el-icon-menu"></i>项目基本信息</template
          >
    ...
    <el-dialog
      ...
      append-to-body
    >
      <el-table :data="this.$store.state.proCreate.user" style="width: 100%">
        <!-- 头像列 -->
        ...
        <!-- 个人简介列 -->
        <el-table-column label="个人简介" width="280">
          <template slot-scope="scope">
            <div>
    ...
    <el-footer>
      ...
      <el-row>
        ...
        <el-col :span="16" :offset="6">
          <div>
            <el-button plain @click="openForm" style="margin-right: 10px"
              >创建阶段</el-button
            >
            <!-- 点击加号键  弹出新增阶段的表单 -->
            <el-dialog
            ...
            >
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click.stop="getFormInfo"
                  >确 定</el-button
                >
              </div>
            </el-dialog>
...
export default {
  ...
  methods: {
    ...
    getFormInfo() {
      ...
      const oneStage = {
        stageName: this.form.name,
        stageId: this.$store.state.proCreate.stage.length + 1,
        stageDetail: this.form.detail,
        stageIsdone: false,
        stageOpenTime: timestampToTime(
          this.form.time[0]
            .toLocaleString("en-US", { hour12: false })
            .split(" ")
        ), // 时间是数组 包含起止时间 格式
        stageCloseTime: timestampToTime(
          this.form.time[1]
            .toLocaleString("en-US", { hour12: false })
            .split(" ")
        ), // 时间是数组 包含起止时间 格式
    ...
    /*打开dialog*/
    openForm() {
      if (!this.dialogFormVisible) this.dialogFormVisible = true;
    },
