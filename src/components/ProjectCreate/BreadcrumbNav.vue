<template>
    <div class="sticky">
        ...
        <!-- 人物头像 点击后跳转到修改个人信息界面 -->
        <el-col :span="1" style="height : 15px"><div shadow="always">
        ...
        <!-- ... 更多操作  点击后弹出下拉菜单 -->
        <el-col :span="1" style="height : 15px"><div>

            <el-dropdown trigger="click" :divided=true>
            <el-button  type="info" icon="el-icon-more" size="mini" circle style="margin-top:-10px"></el-button>
            <el-dropdown-menu slot="dropdown" :divided=true>
              <el-dropdown-item style="height : 55px">Sign in as<P style="margin-top : -10px" >111</P></el-dropdown-item>
